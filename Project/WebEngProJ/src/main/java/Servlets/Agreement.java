...
public class Agreement extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Agreement</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Agreement at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response){
        try {
            String State = request.getParameter("agreement");
            ...
            if(State.equals("1"))
            {
                ...
                if(MakeAppointment.Update(Current.getNumofVac()+1,Current,Current.getVacType(),Date)){
                    DBMan.UpdateCitizen(con,Date,"ThirdVacD",Current.getID());
                }
            }
